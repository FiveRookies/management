...
<script>
    import graph1Vue from './graph1';
    import graph2Vue from './graph2';
    import graph3Vue from './graph3';
    import graph4Vue from './graph4';
    import $ from "jquery";
    ...
    export default {
        ...
        data() {
            return {
                ...
                starPic: require('../assets/image/star.png'),
                contributionList: [{
                        headImage: require('../assets/image/man1.jpg'),
                        rank: 1,
                        name: '瑶瑶欲坠',
                        starNum: 5
                    },
                    {
                        headImage: require('../assets/image/man2.jpg'),
                        rank: 2,
                        name: '杏仁不见了',
                        starNum: 4
                    },
                    {
                        headImage: require('../assets/image/man3.jpg'),
                        rank: 3,
                        name: '牛奶与密封',
                        starNum: 4
                    },
                    {
                        headImage: require('../assets/image/man4.jpg'),
                        rank: 4,
                        name: '南风与鸢尾',
                        starNum: 3
                    },
                    {
                        headImage: require('../assets/image/man6.jpg'),
                        rank: 5,
                        name: '干瘪的土豆',
                        starNum: 3
                    }
