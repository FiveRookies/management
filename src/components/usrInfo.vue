    ...
    <div id="centerContain">
        ...
        <div class="showContent" v-if="isBasicInfo">
            <div class="headImageBox">
                <img v-bind:src="usrHeadImage">
                <div class="choosePic">
                    <input id="getPicFromLocal" type="file" v-on:change="upLoadPic">
                     <button v-on:click="updateAll()">确认上传</button>
                </div>
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" v-if="!isChange" v-model="name"
                            ...
                            @blur="blurName"
                        >
                        <p v-if="nameErr" style="color:red; margin-left:20px;">{{nameErrStr}}</p>
                    </li>
                    <li>
                        <p>职位：</p>
                        <p>{{pos}}</p>
                    ...
                    <li>
                        ...
                        <input type="text" v-if="!isChange" v-model="email"
                            ...
                            @blur="blurEmail"
                        >
                        <p v-if="emailErr" style="color:red; margin-left:20px;">{{emailErrStr}}</p>                        
                    </li>
                    <li>
                        <p>手机号：</p>
                        ...
                        <input type="text" v-if="!isChange" v-model="phone"
                            ...
                            @blur="blurPhone"
                        >
                        <p v-if="phoneErr" style="color:red; margin-left:20px;">{{phoneErrStr}}</p>                        
                    </li>
                </ul>
        ...
        <div id="personas" v-show="isPersonas">
        ...
        <div id="myFollows" v-show="isMyFollows">
            <div class="myFansRow">
        ...
        <div id="myMsgs" v-show="isMyMsgs">
            <div class="msgBox">
                <div class="msgItem" v-for="(msgItem,index) in msgData" v-on:click="checkTheMsg(index)" v-bind:style="{backgroundColor:curCheckMsg==index?'rgb(39,166,155)':'#ffffff'}">
            ...
            <div class="showMsgBox">
                <span v-show="isNoMsg">From:吴正</span>
                ...
                <div class="editBox">
                    ...
                    <div class="deleteBtn" v-on:click="deleteMsg">删除</div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                username:'',
                isNoMsg:true,
                usrHeadImage: require('../assets/image/user.jpg'),
                name: '沈继涛',
                pos: '部门经理',
                sex: '女',
                age: '20',
                ...
                fansInfoData: [{
                        image: require('../assets/image/faith.jpg'),
                        name: 'faith'
                    },
                    {
                    ...
                    {
                        image: require('../assets/image/大鹏.jpg'),
                        name: '大鹏'
                    },
                    {
                        image: require('../assets/image/晶玉翡翠.jpg'),
                        name: '晶玉翡翠'
                    },
                    {
                        image: require('../assets/image/峍屿k.jpg'),
                        name: '峍屿k'
                    },
                    {
                        image: require('../assets/image/逆流_而下.jpg'),
                        name: '逆流_而下'
                    },
                    {
                        image: require('../assets/image/My未來式.jpg'),
                        name: 'My未來式'
                    },
                    {
                        image: require('../assets/image/宇欣.jpg'),
                        name: '宇欣'
                    },
                    {
                        image: require('../assets/image/36kr.jpg'),
                        name: '36kr'
                    },
                    {
                        image: require('../assets/image/JavaScript_w.jpg'),
                        name: 'JavaScript_w'
                    },
                    {
                        image: require('../assets/image/Paper_weekly.jpg'),
                        name: 'Paper_weekly'
                    },
                    {
                        image: require('../assets/image/大咖.jpg'),
                        name: '大咖'
                    },
                    {
                        image: require('../assets/image/家v.jpg'),
                        name: '家v'
                    },
                    {
                        image: require('../assets/image/27375871.jpg'),
                        name: '27375871'
                    },
                    {
                        image: require('../assets/image/切格瓦拉.jpg'),
                        name: '切格瓦拉'
                    },
                    {
                        image: require('../assets/image/切格瓦拉.jpg'),
                ...
                followsInfoData: [{
                        image: require('../assets/image/头头不可一世.jpg'),
                        name: '头头不可一世'
                    },
                    {
                        image: require('../assets/image/徐林森.jpg'),
                        name: '徐林森'
                    },
                    {
                        image: require('../assets/image/泽宇.jpg'),
                        name: '泽宇'
                    },
                    {
                        image: require('../assets/image/总为你着迷.jpg'),
                        name: '总为你着迷'
                    },
                    {
                        image: require('../assets/image/依萍.jpg'),
                        name: '依萍'
                    },
                    {
                        image: require('../assets/image/周扬.jpg'),
                        name: '周扬'
                    }
                ],
                msgData: [{
                        image: require('../assets/image/man1.jpg'),
                        word: '下午那个文档能不能发我...',
                        name: '李雷',
                    ...
                    {
                        image: require('../assets/image/man2.jpg'),
                        word: '标题党，通篇都在长篇大...',
                        name: '张鹏',
                    ...
                    {
                        image: require('../assets/image/man3.jpg'),
                        word: '大佬能不能谈一下对区块...',
                        name: '吴亦凡',
                    ...
                    {
                        image: require('../assets/image/man4.jpg'),
                        word: '开头的条理很清晰，后面...',
                        name: '小明',
        ...
        methods: {
            ...
            blurName : function(){
                ...
                {
                    this.nameErr=true;
                    this.nameErrStr='姓名不能为空';
                }
                else {
                    var reg=/^[\u4E00-\u9FA5\uf900-\ufa2d·s]{2,20}$/;
                    if(!reg.test(this.name)){
                        this.nameErr=true;
                        this.nameErrStr='请正确输入名字';
                    }
                    else{
                        this.nameErr=false;
                    }
            ...
            blurEmail : function(){
                if(this.email=='')
                {
                    ...
                    this.emailErr=true;
                    this.emailErrStr='请输入邮箱';
                }
                else {
                    var reg=/\w[-\w.+]*@([A-Za-z0-9][-A-Za-z0-9]+\.)+[A-Za-z]{2,14}/;
                    if(!reg.test(this.email)){
                        this.emailErr=true;
                        this.emailErrStr='邮箱非法';
                    }
                    else{
                        this.emailErr=false;
                    }
            ...
            deleteMsg:function(){
                var curIndex = this.curCheckMsg;
                this.msgData.splice(curIndex,1);
                console.log(curIndex);
                console.log(this.msgData.length)
                if(curIndex>=this.msgData.length){
                    curIndex = 0;
                    this.curCheckMsg = curIndex;
                    this.curMsgContent = "没有消息";
                    this.isNoMsg = false;
                }
                else{
                    this.isNoMsg = true;
                    this.curMsgContent = this.msgData[curIndex].content;
                }
            ...
            editTheInfo: function() {
                if (this.isChange == true) {
                    ...
                    this.isChange = true;
                    this.editTip = '编辑资料';
                    if(this.nameErr==false && this.emailErr==false && this.phoneErr==false){
                        var infoSex ={
                            "username": this.username,  
                            "sex": this.sex,
                        };
                        $.ajax({  
                            url :"http://www.ls1rius.com:8080/updateSex",   
                            cache : true, 
                            type : "get",
                            xhrFields: {
                        ...
                        $.ajax({  
                            url :"http://www.ls1rius.com:8080/updateAge",   
                            cache : true, 
                            type : "get",
                            xhrFields: {
                                withCredentials: true
                        ...
                        $.ajax({  
                            url :"http://www.ls1rius.com:8080/updateName",   
                            cache : true, 
                            type : "get",
                            xhrFields: {
                                withCredentials: true
                            ...
                            success : function (data){  
                                console.log(data);
                                self.$emit('ChangeName',self.name);
                            }
                        })
                        var infoEmail = {
                            "username": this.username,  
                        ...
                        $.ajax({  
                            url :"http://www.ls1rius.com:8080/updateEmail",   
                            cache : true, 
                            type : "get",
                            xhrFields: {
                                withCredentials: true
                        ...
                        $.ajax({  
                            url :"http://www.ls1rius.com:8080/updatePhone",   
                            cache : true, 
                            type : "get",
                            xhrFields: {
                                withCredentials: true
            ...
            upLoadPic: function(event) {
                ...
                if (FileReader && files) {
                    ...
                    fr.onload = function() {
                        ...
                        vm.$data.usrHeadImage = fr.result;
                        var formData = new FormData();
                        formData.append("file", files);
                        $.ajax({  
                            url :"http://www.ls1rius.com:8080/upload/singleFile",   
                            cache : true, 
                            type : "post",
                            xhrFields: {
                                withCredentials: true
                ...
                // formData.append("file", files);
                // $.ajax({  
                //     url :"http://www.ls1rius.com:8080/upload/singleImage",   
                //     cache : true, 
                //     type : "post",
                //     xhrFields: {
                //         withCredentials: true
            ...
            updateAll:function(){
                var vm = this;
                vm.$emit('ChangeHeadImage',vm.$data.uploadPicURL);
                                var infoHeadImage = {   
                                    "username": vm.$data.username,  
                                    "headImage": vm.$data.uploadPicURL,
                                }   
                                $.ajax({  
                                    url :"http://www.ls1rius.com:8080/updateHeadImage",   
                                    cache : true, 
                                    type : "get",
                                    xhrFields: {
                                        withCredentials: true
...
<style>
    ...
    .slidePickBar {
        width: 100%;
        height: 50px;
        border-bottom: 5px solid rgb(39,166,155);
    }
