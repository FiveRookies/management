        ...
        <div class="rightContain" style='position: relative;'>
            ...
            <div class="ztree_btn_box">
                ...
                <div id="uploader" class="wu-example">
					<button class="btn_type" id="dosomething" style='float: left;width:8%' @click="jinru()">进入编辑</button>
                    ...
                    <el-upload
					  ...
					  <el-button id="picker"  class="btn_type" style='padding:1px 6px;width:100%;margin-left:10px' slot="trigger" size="small" type="primary" @click="this.fileList=[];">选取文件</el-button>
					  <el-button id="ctlBtn" class="btn_type" style='padding:1px 6px;width:66%;margin-left:33px'  size="small" type="success"  @click="submitUpload">开始上传</el-button>
					 
					</el-upload>
				
					<a style='width:8%;' class='downs'><button id="ctlBtn" style='width:100%;margin-left:10px' @click="down()">开始下载</button></a>
                    <input type="button" @click="saveCurStatus()" value="保存">
                </div>
            </div>
             ...
             $.ajax({  
                ...
                success : function (data){  
                    ...
                    $.ajax({  
                        ...
                        success : function (data){  
                            // console.log(self.transData(data, 'id', 'pid', 'children'));
                            if(self.transData(data, 'id', 'pid', 'children')!=null){
