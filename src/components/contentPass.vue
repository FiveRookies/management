            ...
            <div style=""></div>
              <i class="iconfont1 icon-gengduo" style="cursor:pointer;float:right" v-on:click="showDropDown()">
                <ul class="dropDown" v-if="isShowDropDown">
                  ...
                  <li v-on:click="updateStatus(0)">待核审</li>
                  <li v-on:click="updateStatus(2)">未通过</li>
          ...
          <div class="notecontent">
            <div class="note">
              ...
              <div class="author">
                  <!-- 头像 -->
                  <a class="avatar" href="">
                      <img v-bind:src="contentData.ownerHeadImage" alt="">
                  </a>
                  <!-- 个人信息 -->
                  <div class="infor">
                      <span class="name">
                      ...
                      <!-- 文章信息数量 -->
                      <div class="meta"><span>{{contentData.date}}</span> <span>字数 2536</span> <span>阅读 41666</span> <span>评论75</span> <span>喜欢 100</span><span>赞赏 1</span></div>
                  </div>
              </div>
              <!-- 文章内容 -->
              ...
              <div class="follow-detail">
                  <div class="info">
                      <a class="avatar" href="/u/811ae6268caa">
                        <img v-bind:src="contentData.ownerHeadImage">
                      </a>           
                      <a class="btn follow" @click="toggleFollow" :class="[followed?'followed':'btn-success']"><i  :class="[followed?'iconfont1 icon-gou':'iconfont ic-follow']"></i><span>{{followed?'已关注':'关注'}}</span></a>
                      <a class="title" href="/u/811ae6268caa">{{contentData.ownerName}}}</a>
                      <img class="badge-icon" data-toggle="tooltip" title="" src="//upload.jianshu.io/user_badge/1d880fd2-14ce-4622-aacb-e5b588515adf" alt="1d880fd2 14ce 4622 aacb e5b588515adf" data-original-title="简书历史优秀作者">
...
export default {
  ...
  methods: {
      backToMain:function(){
          this.$route.push("/module/homePageForDepartAdmin");
      },
      ...
      getParams:function(){
          ...
          let routerParams  = this.$route.params.articleInfo;
          this.contentData = routerParams;
